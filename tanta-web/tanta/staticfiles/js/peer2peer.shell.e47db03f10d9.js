p2p.shell = (function () {
	...
	toggleTab = function (selected) {
		if (selected) {
			...
			jqueryMap.$container.find('#info').empty()
			jqueryMap.$container.find('#info').html('<li class="mx-auto"><h4 class="mx2">Loan ID</h4></li>'
				+'<li class="mx-auto"><h4 class="mx2">Loan Amount</h4></li>'
				+'<li class="mx-auto"><h4 class="mx2">Interest Rate</h4></li>'
				+'<li class="mx-auto"><h4 class="mx2">Time Left</h3></li>');
		}
			else {
				...
				+'<li class="mx-auto"><h4 class="mx2">Loan Amount</h4></li>'
				+'<li class="mx-auto"><h4 class="mx2">Interest Rate</h4></li>'
				+'<li class="mx-auto"><h4 class="mx2">Time Left</h4></li>');
