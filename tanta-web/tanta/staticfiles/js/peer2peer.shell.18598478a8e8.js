p2p.shell = (function () {
	...
	var
		configMap = {
			...
			+'<li class="inline-block mr1"><h4 class="view borrow center border-top border-right border-left rounded-top px1" style="background: #fafafa; cursor: pointer;" id="view_type">Borrow</h3></li>'
			+'<li class="inline-block mr1"><h4 class="view lend center border-top border-right border-left rounded-top px1" style="background: #fafafa; cursor: pointer;" id="view_type">Lend</h3></li>'
			+'</div>'
