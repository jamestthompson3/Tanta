p2p.shell = (function () {
	...
	var
		configMap = {
			...
			+'<li class="inline-block mr1"><h4 class="view border-top border-right border-left rounded-top px1" style="background: #fafafa;" id="view_type">Borrow</h3></li>'
			+'<li class="inline-block mr1"><h4 class="view border-top border-right border-left rounded-top px1" style="background: #fafafa;" id="view_type">Lend</h3></li>'
			+'</div>'
	...
	onClickTab = function (event) {
		jqueryMap.$tab.css("background-color", "#fafafa");
		...
		Object.assign(event.target.style,{background: "#f48668"});
		changeAnchorPart({
